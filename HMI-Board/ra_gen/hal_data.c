...
const transfer_cfg_t g_transfer12_cfg =
{
    ...
    .p_extend            = &g_transfer12_cfg_extend,
};

/* Instance structure to use this module. */
const transfer_instance_t g_transfer12 =
{
    .p_ctrl        = &g_transfer12_ctrl,
    .p_cfg         = &g_transfer12_cfg,
...
{
    .p_info              = &g_transfer11_info,
    .p_extend            = &g_transfer11_cfg_extend,
};

/* Instance structure to use this module. */
const transfer_instance_t g_transfer11 =
{
    .p_ctrl        = &g_transfer11_ctrl,
    .p_cfg         = &g_transfer11_cfg,
    .p_api         = &g_transfer_on_dtc
};
...
const spi_extended_cfg_t g_spi1_ext_cfg =
{
    ...
    .spck_div            = {
        /* Actual calculated bitrate: 29297. */ .spbr = 255, .brdv = 3
    },
...
const dmac_extended_cfg_t g_transfer9_extend =
{
    .offset              = 1,
    .src_buffer_size     = 1,
...
const transfer_cfg_t g_transfer9_cfg =
{
    ...
    .p_extend            = &g_transfer9_extend,
};
/* Instance structure to use this module. */
const transfer_instance_t g_transfer9 =
{
    .p_ctrl        = &g_transfer9_ctrl,
    .p_cfg         = &g_transfer9_cfg,
...
sdmmc_cfg_t g_sdmmc0_cfg =
{
    ...
    .p_extend               = NULL,
    .p_lower_lvl_transfer   = &g_transfer9,
...
can_bit_timing_cfg_t g_can0_bit_timing_cfg =
{
    /* Actual bitrate: 1000000 Hz. Actual Bit Time Ratio: 80 %. */  .baud_rate_prescaler = 1 +2 /* Division value of baud rate prescaler */, .time_segment_1 = 15, .time_segment_2 = 4, .synchronization_jump_width = 4,
};
#endif
